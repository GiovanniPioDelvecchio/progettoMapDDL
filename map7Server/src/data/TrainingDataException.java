 ...
 * Poichè è possibile lanciarla solamente all'interno del costruttore di Data ma è possibile gestirla in
...
public class TrainingDataException extends Exception {
	 ...
	 * Poichè è possibile lanciarla solo durante la costruzione di un'istanza di Data, la visibiltà
	 * è limitata al package. Chiama il costruttore di Exception.
	 * 
