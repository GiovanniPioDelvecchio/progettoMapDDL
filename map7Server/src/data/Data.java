...
public class Data {
	...
	/**
	 * Attributo continuo di classe, o "attributo target", del training set, da predire.
	 */
	 ...
	 * 
	 * @return Un oggetto di tipo <code>Object</code> contenente il valore dell'attributo indicato nell'esempio specificato.
	 * 
	 ...
	 *
	 * @return L'attributo continuo (target) nel training set.
	 */
	 ...
	 * 
	 * @throws IndexOutOfBoundsException Lanciata se uno dei due indici e' fuori range oppure
	...
	/**
	 * Metodo che cambia di posizione due esempi nel set. Viene utilizzato per l'implementazione del quicksort.
	 * 
