...
public class DiscreteAttribute extends Attribute implements Iterable<String>{
	...
	/**
	 * Costruttore per DiscreteAttribute.
	 * Richiama il costruttore della classe Attribute e poi avvalora il dominio dell'attributo
	...
	/**
	 * Override del metodo dell'interfaccia Iterable che restituisce una istanza di iterator, utile a scorrere
